(() => {
  ...
  function renderPlaylistDetail() {
    ...
    if (els.playlistPlayBtn) els.playlistPlayBtn.disabled = !(playlist.playlist_items || []).length;
    if (els.playlistShuffleBtn) els.playlistShuffleBtn.disabled = !(playlist.playlist_items || []).length;
