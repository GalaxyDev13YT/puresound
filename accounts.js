(() => {
  ...
  function renderPlaylistDetail() {
    ...
    if (els.playlistCoverImage && els.playlistCoverFallback) {
      if (coverUrl) {
        els.playlistCoverImage.onerror = () => {
        ...
        els.playlistCoverImage.referrerPolicy = "no-referrer";
    ...
    playlistItems.forEach((item, index) => {
      ...
      if (record.coverUrl) {
        ...
        primeArtworkImage(cover, () => {
          const fallback = document.createElement("div");
          fallback.className = "playlist-item-cover";
          fallback.textContent = initialsFor(`${record.artist} ${record.title}`);
