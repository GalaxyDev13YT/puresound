(() => {
  ...
  function renderPlaylistList(playlists, publicView) {
    ...
    playlists.forEach((playlist) => {
      ...
      meta.textContent = `${count} ${count === 1 ? "track" : "tracks"}${playlist.is_public ? " ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ public" : " ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ private"}`;
  ...
  function renderPlaylistDetail() {
    ...
    if (els.playlistDetailMeta) {
      ...
      els.playlistDetailMeta.textContent = `${items.length} ${items.length === 1 ? "track" : "tracks"} ${playlist.is_public ? "ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ public" : "ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ private"}`;
    }
