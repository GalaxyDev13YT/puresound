...
function bindElements() {
  [
    ...
    "searchResultsSection", "searchTrackList", "albumList", "libraryPagination", "libraryEmpty", "libraryPanel", "releaseGridView", "settingsPanel", "cacheToggle", "clearCacheBtn", "cacheCount",
...
function renderSearchTracks() {
  ...
  state.filteredTracks.forEach((track) => {
    const button = document.createElement("button");
    button.type = "button";
    button.className = "search-track-item" + (track.id === state.currentTrackId ? " is-active" : "");
    button.addEventListener("click", () => playTrackById(track.id, { autoPlay: true }));
